...
lambdaP = 1030e-9;
lambdaL = 1050e-9;
lambdaS = [1040e-9:dlam:lambdaL-dlam lambdaL lambdaL+dlam:dlam:1150e-9];%[lambdaL:dlam:1150e-9];%[1035e-9:dlam:lambdaL-dlam lambdaL lambdaL+dlam:dlam:1150e-9]; %%MAYBE CHANGE THIS -- to make spacing even
freqP = c/lambdaP;
freqS = c./lambdaS;
...
PSout = zeros(1,length(Pp0)); %stores the output power of the laser for each Pp0
...
%method 1: Pabs-Ps 
PSout(p) = Psforward(indexL,length(z))*t2
