...
lambdaP = 1035e-9:1e-9:1065e-9;%980e-9:2e-9:1050e-9;%860e-9:10e-9:1050e-9;
...
noTempChange = @(pump) N0*PsatP/PsatPa*log((1+pump/PsatP*exp(-2*core_radius^2/w^2))/(1+pump/PsatP))*(Am*h*freqF_SE/tauRad-(cs_aP(l)+cs_eP(l))*PsatP)...
