...
lambdaP = 1020e-9:1e-9:1040e-9;%980e-9:2e-9:1050e-9;%860e-9:10e-9:1050e-9;
...
mindQz_dt2 = zeros(2,length(lambdaP)); %stores the coordinates of the maximum value of dQz_dt2
...
[mindQz_dt2(1,l), mindQz_dt2(2,l)] = min(dQz_dt2(l,:));
